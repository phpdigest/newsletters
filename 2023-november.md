...
<details>
  <summary>Установка/Обновление до PHP 8.3</summary>
    ...
    <p>**Windows:** Скомпилированные двоичные файлы доступны на сайте [windows.php.net](https://windows.php.net).</p>
    <p>**Ubuntu/Debian:** PHP 8.3 доступен на [ondrej/php](https://launchpad.net/~ondrej/+archive/ubuntu/php/) PPA.</p>
    <p>**Fedora/RHEL/CentOS/Alma/Rocky:** Доступен в виде коллекции программ php83 в [репозитории Remi](https://blog.remirepo.net/).</p>
    <p>**macOS:** PHP 8.3 можно установить с помощью Homebrew совместно с [shivammathur/homebrew-php](https://github.com/shivammathur/homebrew-php/packages).</p>
    <p>**Docker:** Образы PHP 8.3 доступны на [Docker Hub](https://hub.docker.com/_/php) с [тегами 8.3*](https://hub.docker.com/_/php/tags?page=1&name=8.3).</p>
</details>
...
>[Описание RFC](https://wiki.php.net/rfc/improve_callbacks_dom_and_xsl)
...
Вы уже можете попробовать хуки свойств на [3v4l.org](https://3v4l.org/), благодаря [Sjon Hortensius](https://github.com/sponsors/SjonHortensius).
...
- Вышел [Yii Config](https://github.com/yiisoft/config) 1.4
